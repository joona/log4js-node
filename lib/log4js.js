...
, LoggingProxy = loggerModule.LoggingProxy
...
function setGlobalLoggingProxy(proxy) {
  proxy || (proxy = LoggingProxy);
  Logger.prototype.loggingProxy = proxy;
}
...
/**
 * Get the default logging proxy
 * @return {LoggingProxy} constructor of default logging proxy
 * @static
 */
function getDefaultLoggingProxy () {
  return LoggingProxy;
}
...
module.exports = {
  ...
  hasLogger: hasLogger,
  getDefaultLoggingProxy: getDefaultLoggingProxy,
  ...
  setGlobalLoggingProxy: setGlobalLoggingProxy,
